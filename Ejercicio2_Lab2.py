...
class Papeleria():
    ...
    def __init__(self, producto="", precioComP=0):
    ...
    def MostrarDatos(self):
        ...
        if (self.precioComp):
            ...
            print(f"Ganancia del producto: ${self.CalcGanancia()}")
...
# Seguidamente llamé los métodos para entrada de datos.
producto = Papeleria()
